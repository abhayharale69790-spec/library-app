...
export const INITIAL_BUSINESS_PROFILE: BusinessProfile = {
  id: 'bp_1',
  name: 'Apex Study Point & Reading Hall',
  type: 'Study Center',
  shortName: 'ASP',
  tagline: 'Premier Air-Conditioned Co-Learning & Study Space',
  phone: '+91 98200 24240',
  whatsapp: '+91 98200 24240',
  email: 'desk@apexstudypoint.in',
  address: 'Knowledge Tower, Near Station, Dadar West, Mumbai',
  location: 'Mumbai, Maharashtra',
  receiptPrefix: 'ASP-',
  currencySymbol: '₹',
  gracePeriodMinutes: 15,
  requireCheckout: true,
  enable7dReminder: true,
  enable3dReminder: true,
  enable1dReminder: true,
  ...
  isConfigured: false, // Default false until owner runs setup wizard or updates profile
...
export const INITIAL_ORG: Organization = {
  ...
  contactEmail: 'desk@apexstudypoint.in',
